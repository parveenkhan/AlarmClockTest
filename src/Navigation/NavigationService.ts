...
class NavigationService {
  static navigate = NavigationController.navigate;
  static push = NavigationController.push;
  static replace = NavigationController.replace;
  static goBack = NavigationController.goBack;
  static resetRoot = NavigationController.resetRoot;
  static resetToHome = NavigationController.resetToHome;
}
